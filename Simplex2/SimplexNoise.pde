...
public static final class SimplexNoise
{
  // 2D simplex noise with derivatives.
  public static float sdnoise2(float x, float y, float[] dnoise)
  {
    ...
    dnoise[0] *= 40.0f; // Scale derivative to match the noise scaling
    dnoise[1] *= 40.0f;
